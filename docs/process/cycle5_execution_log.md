...
- [src/backup/db_backup.sh](file:///d:/Project/final-bdes/src/backup/db_backup.sh) (Đã kiểm tra)
- [src/backup/db_restore.sh](file:///d:/Project/final-bdes/src/backup/db_restore.sh) (Đã kiểm tra)
- [bin/run.sh](file:///d:/Project/final-bdes/bin/run.sh) (Đã tích hợp Port Checks và tự động kích hoạt dịch vụ)
- [.gitignore](file:///d:/Project/final-bdes/.gitignore) (Cập nhật để bỏ qua thư mục `data/backups/`, `data/db/`, `data/hdfs/`, `data/raw/` và `tmp-pandas/`)
